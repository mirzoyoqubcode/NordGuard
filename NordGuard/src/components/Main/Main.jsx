...
const Main = ({type, color}) => {
    ...
    const isValidFileType = (file) => {
        ...
        const acceptedMimeTypes = ["text/csv", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/vnd.ms-excel"];
    ...
    const xlsxToJson = async (xlsxContent) => {
        ...
        const jsonData = XLSX.utils.sheet_to_json(workbook.Sheets[workbook.SheetNames[0]], {header: 0});
        return jsonData;
    };
                    ...
                    <div className={styles.drag_drop} {...getRootProps()}>
                        ...
                        {isDragActive ? (
                            ...
                            <p>
                                ...
                                <p>Drop .csv or .xlsx file here</p>
                            </p>
                        )}
                    </div>
